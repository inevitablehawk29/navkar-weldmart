...
export const partners: Partner[] = [
  ...
  { name: "Tata Structura", logo: "/images/partners/tata_structura_logo_fixed.webp", className: "scale-[1.25]" },
  { name: "Jindal Steel & Power", logo: "/images/partners/Jindal_Steel_Limited_Logo_fixed.webp", className: "scale-[1.25]" },
